...
class RailsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create rail" do
    assert_difference('Rail.count') do
      post rails_url, params: { rail: { Blog: @rail.Blog, g: @rail.g, scaffold: @rail.scaffold, title: @rail.title } }
    end
  ...
  test "should update rail" do
    patch rail_url(@rail), params: { rail: { Blog: @rail.Blog, g: @rail.g, scaffold: @rail.scaffold, title: @rail.title } }
